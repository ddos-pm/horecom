...
const FAQ = [
  ...
  },
  {
    ...
    answer:
      "Сейчас доставка только по Астане. В 2026 году запускаем Алматы как второй город. Если вы из другого города и хотите узнать о возможности доставки — напишите нам в WhatsApp.",
  },
  {
