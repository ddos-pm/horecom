      ...
      <section className="space-y-6">
        ...
        <ol className="space-y-4">
          ...
          <Step
            ...
            text="Выберите адрес, день и время доставки. Бесплатная доставка от 20 000 ₸."
          />
          <Step
            n={4}
            title="Оплатите через Kaspi или безналом"
            text="Для физлиц и ИП — ссылка KaspiPay в WhatsApp. Для юрлиц — счёт на оплату по запросу и безналичный перевод по реквизитам. Документы (счёт-фактура, накладная) приходят на email."
          />
        </ol>
