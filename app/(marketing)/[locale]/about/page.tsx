  ...
  return (
    <div className="container-tight py-8 max-w-3xl">
      ...
      <div className="prose prose-slate max-w-none space-y-4 text-foreground">
        ...
        <p>
          За плечами команды — 10 лет в кондитерской дистрибуции в Астане и опыт продуктового менеджмента
          в tech-компаниях. Подробности готовы рассказать в переписке.
        </p>
